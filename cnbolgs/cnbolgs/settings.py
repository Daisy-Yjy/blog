"""
Django settings for cnbolgs project.
...
SECRET_KEY = '=+5k_g-@_()1jaodrkunvv30443+m*@&ac^l_&0&n*_3@b(%-k'
...
INSTALLED_APPS = [
    ...
    'articles.apps.ArticlesConfig',  # 文章模块
]
...
WSGI_APPLICATION = 'cnbolgs.wsgi.application'
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = 'jinyueyan3@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'GCWYMNCEYNBLNCID'
# 收件人看到的发件人
